...
![](https://d2h0cx97tjks2p.cloudfront.net/blogs/wp-content/uploads/sites/2/2016/09/Hadoop-MapReduce-vs-Apache-Spark.jpg)
...
- <div class="highlight">[gitter.im/rstudio/sparklyr](https://gitter.im/rstudio/sparklyr):</div> Anything urgent? Chat with on the RStudio `sparklyr` **Gitter**!
- <div class="highlight">[https://docs.databricks.com/spark/latest/sparkr](https://docs.databricks.com/spark/latest/sparkr/sparklyr.html):</div> Databricks Spark + R **documentation**?
